        ...
        while (window.pollEvent(event)) {
            ...
            if (event.type == sf::Event::MouseButtonPressed) {
                if (event.mouseButton.button == sf::Mouse::Left) {
                    ...
                    else if (mathY < y2 && mathY < y1) { zone = "Zone 2"; }
                    else if (mathY > y2 && mathY > y1) { zone = "Zone 3"; }
                    else if (mathY > y2 && mathY < y1 && mathX < 0) { zone = "Zone 4"; }
                    else if (mathY > y2 && mathY < y1 && mathX > 0) { zone = "Zone 5"; }
                    else { zone = "Border"; }
