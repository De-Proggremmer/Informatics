...
int main() {
    ...
    map<string, Coord> nodes;
    vector<EdgeItem> edges;
    std::tie(nodes, edges) = read_graphml("slovenia.graphml");
    ...
    string start_street_query = "Srednje Gameljne";      // Название улицы для старта (пример)
    string end_street_query = "Ocvirkova ulica";      // Название улицы для финиша (пример) Petkova ulica
